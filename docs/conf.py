# -*- coding: utf-8 -*-
#
# pgmock documentation build configuration file, created by
...
version = str(pgmock.__version__)
...
latex_documents = [(
    master_doc,
    'cookiecutterrepo_name.tex', 'pgmock Documentation',
...
man_pages = [
    (master_doc, 'cookiecutterrepo_name', 'pgmock Documentation',
     [author], 1)
]
